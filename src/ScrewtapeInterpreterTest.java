...
void testNoOpeningBracket() {
  ...
  // Assert
    assertEquals("Error: Unmatched brackets at index: 2", exception.getMessage());
}
...
void testNoClosingBracket() {
  ...
  // Assert
    assertEquals("Error: Unmatched brackets at index: 0", exception.getMessage());
}
  ...
  @Test
  void test2UnmatchedClosingBrackets() {
      // Arrange
        ScrewtapeInterpreter interpreter = new ScrewtapeInterpreter();
        String program = "+-]]";
      ...
      // Act
       ...
       // Assert
        assertEquals("Error: Unmatched brackets at index: 2, 3", exception.getMessage());
  }
  

  @Test
  void test2UnmatchedOpeningBrackets() {
      // Arrange
        ScrewtapeInterpreter interpreter = new ScrewtapeInterpreter();
        String program = "[[+";
      ...
      // Assert
        assertEquals("Error: Unmatched brackets at index: 0, 1", exception.getMessage());
}
